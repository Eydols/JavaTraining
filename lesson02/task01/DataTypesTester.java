public class DataTypesTester {
	...
	public static void testString() {
		...
		System.out.println("/n***** Arithmetical Operator *****");
		str3 = str1 + str2;
		System.out.printf("str3 = %s\n", str3);
		...
		bool = (str2 instanceof Object);
		System.out.printf("str2 relate to class Object --> %b\n", bool);
}

	public static void testStudent() {
		Student st1 = new Student("Alex", 30);
		Student st2 = new Student("Oleg", 25);
		Student st3;
		boolean bool;
		
		System.out.println("\n***** Assignment Operators *****");
		st3 = st1;
		System.out.printf("st3 --> %s\n", st3.toString());
		
		System.out.println("\nCondition Operator:");
		System.out.printf("st1 == st2 --> %b\n", ((st1 == st2) ? true : false));
		System.out.printf("st1 != st2 --> %b\n", ((st1 != st3) ? true : false));
		
		System.out.println("/n***** Type comparison operator *****");
		bool = (st1 instanceof Student);
		System.out.printf("st1 relate to class Student --> %b\n", bool);
}
